...
<!--    <h1>Přidání nového receptu</h1>-->
    <form class="novy_recept" method="post" id="novy_rcept" action="">
        Název receptu:<br>
        <input type="text" class="form-control" name="nazev"  id="nazev" value="" placeholder="Název receptu" required>
        <br><br>
        Popis receptu:<br>
        <textarea name="popis" class="form-control" rows="4" cols="30" id="popis" ></textarea>
        <br><br>
        PDF Soubor:<br>
        <input type="file" class="form-control" name="soubor" accept=application/pdf" id="soubor" multiple>
        <br><br>
