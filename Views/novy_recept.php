...
?>
<div class="container mt-4" id="forms" xmlns="http://www.w3.org/1999/html">
    <div class="row-padded">
        <div class="form-group text-center">
            <form class="novy_recept" method="post" id="novy_rcept" action="">
                ...
                <br>
                <br>
                <label>Popis receptu <br><textarea name="recept_ob" rows="4" cols="30" id="recept_ob" value="<?php echo $tplData['obsah']['value'];?>" required></textarea></label>
                <span class="error"> <?php echo $tplData['obsah']['error'];?></span>
                <br>
                <br>
                <label>PDF Soubor<br><input type="file" name="soubor" accept="application/pdf" id="soubor" multiple></label>
                <br><br>
